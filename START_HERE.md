...
- Печать нескольких горизонтальных таблиц подряд
- Печать нескольких вертикальных таблиц одна под другой
- **НОВОЕ: Универсальный метод для любых комбинаций**
...
### Если нужна печать нескольких вертикальных таблиц:
👉 Откройте **[VERTICAL_MULTI_TABLE_GUIDE.md](VERTICAL_MULTI_TABLE_GUIDE.md)**

### НОВОЕ: Универсальный метод (рекомендуется для новых проектов):
👉 Откройте **[UNIVERSAL_METHOD_GUIDE.md](UNIVERSAL_METHOD_GUIDE.md)**
